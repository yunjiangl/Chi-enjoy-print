...
public class OwnerController {
	...
	@ACSPermissions(permissions = "user:Integer")
	@ApiImplicitParams({@ApiImplicitParam(paramType = "query", dataType = "String", name = "openingBank", value = "开户行", required = true),
	...
	public DefaultResopnseBean<Object> updateBank(String openingBank, String province, String city, 
												String region, String accountNumber,String accountName,String userName){
		Integer updateBankInt=sysOwnerUserService.updateBank(openingBank, province, city, region, accountNumber, accountName,userName);
	...
	@ACSPermissions(permissions = "user:Integer")
	@ApiImplicitParams({@ApiImplicitParam(paramType = "query", dataType = "String", name = "printerCode", value = "打印机Code", required = true)})
