...
public class PrinterController extends BaseController {
    ...
    @ResponseBody
    public DefaultResopnseBean<PageResponseBean<UserDetailsBean>> attorney(@ApiParam("第几页") @RequestParam("page") Integer page,
                                                                          @ApiParam("每页多少条") @RequestParam("pageSize") Integer pageSize,
                                                                          @ApiParam("打印机code") @RequestParam("code") String code,
                                                                          HttpServletRequest request) {
        servletPath = request.getServletPath();
