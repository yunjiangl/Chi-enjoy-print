package com.zx.share.platform.util.sig;
	...
	public static void main(String[] args) {
		try{			
		    ...
		    String privStr = "-----BEGIN PRIVATE KEY-----\n" +
					"MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgddwl6KPBy5cQOk+w\n" +
					"k7vzNMbSTcN/a8TWkRC8XlyBhWehRANCAAQVzUHDqR9EaLgt0YLaXu1mISkck5hW\n" +
					"XAWFLnYNk549QlOhPoRdhHBHA6lVS9oCVNEwBvk3oRF1RVFBo81KFnTB\n" +
					"-----END PRIVATE KEY-----";
		    
			//change public pem string to public string
			String pubStr = "-----BEGIN PUBLIC KEY-----\n" +
					"MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEFc1Bw6kfRGi4LdGC2l7tZiEpHJOY\n" +
					"VlwFhS52DZOePUJToT6EXYRwRwOpVUvaAlTRMAb5N6ERdUVRQaPNShZ0wQ==\n" +
					"-----END PUBLIC KEY-----";

            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400090381, "lumotuwe2", privStr);
            ...
            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400090381, "lumotuwe2", pubStr);
