...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" href="/public/lib/layui/css/modules/layer/default/layer.css">
     <link rel="stylesheet" href="/public/css/devicelist-manage.css">
...
<div class="addDevice">
		<div v-if="msg" class="alert alert-danger alert-dismissible">
        	<h4><i class="fa fa-exclamation-triangle"></i> {{resultMsg}}</h4>
      	</div>
<ul>
    <li><font>设备编码</font><input type="text" class="layui-input" v-model="deviceCode" placeholder="输入设备编码"></li>
    <div style="clear: both;"></div>
    <li><font>设备物主</font><input type="text" class="layui-input" v-model="nickName" placeholder="输入设备物主"></li>
    <div style="clear: both;"></div>
    <li>
        <font>设备地址</font>
   <div class="input-select-inline" style="z-index:566;">
    ...
    <div style="clear: both;"></div>
    <li><font>详细地址</font><input type="text" v-model="deviceDetailedAddress" class="layui-input" placeholder="输入设备详细地址"></li>
    <div style="clear: both;"></div>
    <li><font>线下管理员</font><input type="text" v-model="offlineAdmin" class="layui-input" placeholder="线下管理员"></li>
    <div style="clear: both;"></div>
    <li><font>管理员电话</font><input type="text" v-model="adminPhoneNum" class="layui-input" placeholder="管理员电话"></li>
    <div style="clear: both;"></div>
    <li><button class="layui-btn hold" @click="add">保存</button></li>
</ul>
</div>
<!-- addDevice end -->
...
var vm = new Vue({
	...
	methods: {
		add: function (event) {
			var deviceAddress = $("#province").val() + $("#citys").val() + $("#citys").val();
			console.log(deviceAddress);
			var data = "deviceCode="+vm.deviceCode+"&deviceAddress="+deviceAddress+"&deviceDetailedAddress="+vm.deviceDetailedAddress+"&offlineAdmin="+vm.offlineAdmin+"&adminPhoneNum="+vm.adminPhoneNum+"&nickName="+vm.nickName;
			$.ajax({
				type: "POST",
			    url: "/sys/manage/device/add",
			    data: data,
