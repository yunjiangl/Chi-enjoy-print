...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: '设备ID', name: 'id', index: "id", width: 45, key: true},
            {label: '设备物主', name: 'sysUser.username', width: 90},
            {
            ...
            {label: '设备添加时间', name: 'createTime', index: "create_time", width: 80},
            {label: '线下管理员', name: 'managerName', width: 100},
            {label: '联系方式', name: 'managerPhone', width: 100}
        ],
        viewrecords: true,
        height: 385,
        rowNum: 10,
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function () {
            ...
            var url = vm.printer.id == null ? "printer/save" : "printer/update";
        ...
        getPrinter: function (userId) {
            $.get(baseURL + "printer/info/" + userId, function (r) {
                vm.printer = r.printer;
                vm.arr=arrAll;
                vm.prov=r.printer.province;
                vm.city=r.printer.city;
                vm.district=r.printer.area;
            });
        },
        ...
        reload: function () {
            ...
            $("#jqGrid").jqGrid('setGridParam', {
                postData: {'name': vm.q.name,'startTime':vm.q.startTime,'endTime':vm.q.endTime,'status':vm.q.status,'printerCode':vm.q.printerCode,'province':vm.q.province=='选择省份'?'':vm.q.province},
                page: page
            }).trigger("reloadGrid");
        },
        validator: function () {
            if (isBlank(vm.printer.name)) {
                alert("名称不能为空");
                return true;
            }
